...
$countFollower->execute([$RandUserId]);
...
$countFollowing->execute([$RandUserId]);
...
<div class="col-12 col-lg-3">
    ...
    <div class="left-column">
        ...
        <div class="card card-left1 mb-4">
            <img src="cover/<?= $RandUserCover ?>" style="max-height: 160px;background-color: #575757;" alt=""
                class="card-img-top img-fluid">
            <div class="card-body text-center">
                <a href="profile.php?id=<?= $RandUserId ?>"><img src="profile/<?= $RandUserProfile ?>" width="110px"
                ...
                <ul class="list-unstyled nav justify-content-center">
                    <a href="follower.php?id=<?= $RandUserId ?>" class="text-decoration-none mx-3">
                        <li class="nav-item">Follower <br> <strong>
                                <?= $rowCountFollower ?>
                            </strong></li>
                    </a>
                    <a href="following.php?id=<?= $RandUserId ?>" class="text-decoration-none mx-3">
        ...
        <div class="card shadow-sm card-left3 mb-4 d-none d-lg-block">
            ...
            <div class="card-body">
                <h5 class="card-title">Photos<small class="ml-2"><a href="profile.php?id=<?= $RandUserId ?>">
                            More</a></small></h5>
